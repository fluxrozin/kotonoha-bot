...
- **NAS 上**: NAS 上で GHCR からイメージをプルする場合は、Personal Access Token を手動で作成して `docker login` する必要があります（詳細は [デプロイメント・運用ガイド](../../operations/deployment-operations.md) を参照）。
...
**重要**: 詳細な手順は [デプロイメント・運用ガイド](../../operations/deployment-operations.md#ghcr-認証の設定方法) を参照してください。
...
- 詳細な手順やトラブルシューティングは [デプロイメント・運用ガイド](../../operations/deployment-operations.md#ghcr-認証の設定方法) を参照してください
...
詳細な確認方法は [デプロイメント・運用ガイド](../../operations/deployment-operations.md) を参照してください。
...
**詳細な手順**: [デプロイメント・運用ガイド](../../operations/deployment-operations.md) を参照してください。
...
**詳細**: [トラブルシューティングガイド](../../operations/troubleshooting.md) を参照してください。
