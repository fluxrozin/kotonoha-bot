...
- 詳細は [Phase 3 実装ガイド](../00_planning/phases/phase03.md) を参照
...
- **Discord Webhook**: `discord://WEBHOOK_TOKEN@WEBHOOK_ID`
  - 詳細な手順は [デプロイメント・運用フロー](../90_90_operations/deployment-operations.md) を参照
...
詳細は [デプロイメント・運用フロー](../90_90_operations/deployment-operations.md) の「1.3 Watchtower について」セクションを参照してください。
