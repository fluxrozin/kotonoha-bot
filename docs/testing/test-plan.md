...
| FT-002 | スレッド型の動作       | 高     | Phase 5      |
| FT-004 | 聞き耳型の動作         | 高     | Phase 5      |
| FT-005 | 会話履歴の保持         | 高     | Phase 1      |
| FT-006 | 会話履歴のリセット     | 中     | Phase 5      |
| FT-007 | セッションの復元       | 中     | Phase 1      |
...
| **Phase 2 テスト** | Phase 2 完了後 | NAS デプロイのテスト |
| **Phase 5 テスト** | Phase 5 完了後 | 全機能のテスト       |
| **Phase 7 テスト** | Phase 7 完了後 | システム全体のテスト |
