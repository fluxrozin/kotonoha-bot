...
- [ADR-0005: 3 つの会話の契機](../../20_architecture/22_adrs/0005-four-conversation-triggers.md)
- [会話の契機の詳細説明](../../10_requirements/12_system-reqs/conversation-triggers.md)
- [実装ロードマップ](../roadmap.md)
...
詳細は [プロンプト管理ガイド](../../50_implementation/51_guides/prompt-management.md) を参照してください。
