...
- `docs/20_architecture/21_system-arch/system-architecture.md`（ディレクトリ構造の変更）
- `docs/20_architecture/21_system-arch/basic-design.md`（モジュール設計の変更）
- `docs/00_planning/roadmap.md`（Phase 8の完了マーク）
