...
詳細は [system-architecture.md](../20_architecture/21_system-arch/system-architecture.md) を参照してください。
...
- **[システムアーキテクチャ](../20_architecture/21_system-arch/system-architecture.md)**: システム構成と技術スタック
- **[基本設計](../20_architecture/21_system-arch/basic-design.md)**: システムの基本設計
- **[詳細設計](../40_design_detailed/41_logic/detailed-design.md)**: モジュール・関数の詳細設計
- **[データベース設計](../40_design_detailed/42_db-schema-physical/database-design.md)**: ER 図とテーブル定義

### 10.3 実装

- **[実装ロードマップ](../00_planning/roadmap.md)**: 段階的な実装計画 ⭐ 実装開始前に必読
- **[実装検討事項](../50_implementation/51_guides/considerations.md)**: 実装前の技術的検討事項
- **[ミドルウェア選定](../20_architecture/22_adrs/middleware-selection.md)**: 技術選定の理由

### 10.4 仕様

- **[API 仕様](../30_design_basic/api-specification.md)**: 外部/内部 API 仕様
- **[イベント仕様](../30_design_basic/event-specification.md)**: Discord イベント処理
- **[コマンド仕様](../30_design_basic/command-specification.md)**: スラッシュコマンド

### 10.5 テスト・運用

- **[テスト計画](../60_60_testing/test-plan.md)**: テスト計画と戦略
- **[テスト仕様](../60_60_testing/test-specification.md)**: テストケース
- **[デプロイメント](../90_90_operations/deployment-operations.md)**: デプロイ手順
- **[トラブルシューティング](../90_90_operations/troubleshooting.md)**: 問題解決ガイド
- **[ヘルスチェック](../90_90_operations/health-check.md)**: ヘルスチェック機能の詳細
